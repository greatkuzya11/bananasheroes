    ...
    function showMobileControlsHintModal() {
        return new Promise(resolve => {
            ...
            const rows = [
                ...
                ['ALT', 'Альтернативная стрельба — нажми для переключения. В ALT направление пули = направление движения.'],
                ['DIR', 'Обычный режим: циклично меняет направление (вверх → влево → вправо → вверх). В ALT удерживай для стрельбы вверх.']
            ];
