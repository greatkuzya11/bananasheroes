...
const CAMPAIGN_LEVEL_META = Object.freeze({
    ...
    nosok:     { title: 'нАсок', desc: 'Просто сделай из него кусок говна!.' },
    ...
    runner:    { title: 'Бегун', desc: 'Дрон должен научиться курить. Даже если не научится, хоть ногу подвернет.' },
